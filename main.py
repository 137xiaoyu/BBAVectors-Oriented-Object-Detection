...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str,
                        default='D:/137/dataset/MunichDatasetVehicleDetection-2015-old/DOTA_All', help='Data directory')
    # parser.add_argument('--data_dir', type=str,
    #                     default='D:/137/dataset/MunichDatasetVehicleDetection-2015-old/DOTA_TrainVal', help='Data directory')
