...
class splitbase():
    ...
    def saveimagepatches(self, img, subimgname, left, up):
        ...
        outdir = os.path.join(self.outimagepath, subimgname + '.png')
...
if __name__ == '__main__':
    ...
    split = splitbase(r'D:/137/dataset/MunichDatasetVehicleDetection-2015-old/Train',
                       r'D:/137/dataset/MunichDatasetVehicleDetection-2015-old/Train-splitted')
    split.splitdata(1)